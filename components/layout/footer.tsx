...
export function Footer() {
  return (
    <footer className="bg-text text-white">
      ...
      <div className="container-wide px-4 sm:px-6 lg:px-8 section-padding pb-8">
        <div className="grid gap-10 md:gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-white/65">
              Cloud-based IVF management for modern fertility clinics and
              hospital chains.
            </p>
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              {socialLinks.map(({ platform, label, href }) => (
                <a
                  ...
                  title={label}
                  className="group flex h-11 w-11 items-center justify-center rounded-xl bg-white/10 text-white/90 ring-1 ring-white/10 transition-all hover:-translate-y-0.5 hover:bg-primary hover:text-white hover:ring-primary/40 hover:shadow-lg hover:shadow-primary/20"
                >
                  <SocialIcon
                    platform={platform}
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 lg:col-span-5">
            {[
              ...
              <div key={group.title}>
                <h3 className="mb-3 text-xs font-bold uppercase tracking-wider text-white/80">
                  {group.title}
                </h3>
          ...
          <div className="lg:col-span-3">
            ...
            <p className="mb-3 text-sm text-white/55">
              IVF insights and product updates.
            </p>
            ...
            <div className="mt-5 space-y-3 text-sm text-white/55">
              <a
                ...
                className="flex items-center gap-2 break-all transition-colors hover:text-primary-light"
              >
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-6 text-center sm:flex-row sm:text-left">
          ...
          <p className="text-xs text-white/45">
            {siteConfig.tagline} — Transforming fertility care.
          </p>
        </div>
      </div>
    </footer>
