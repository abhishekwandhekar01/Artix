...
const cardImages = [images.hospital, images.embryology, images.dashboard, images.technology];
            ...
            {whyArtix.map((item, i) => (
              ...
              >
                <div className="relative h-40">
                  <SafeImage src={cardImages[i]} alt="" fill className="object-cover" sizes="50vw" />
